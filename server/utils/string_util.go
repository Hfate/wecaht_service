...
func init() {
	...
	//CSSStyleMap["<li><p>"] = "<li><p style=\"margin: 5px; max-width: 100%; min-height: 1em; white-space: pre-wrap; text-align: justify;  line-height: 1.75 box-sizing: border-box !important; word-wrap: break-word !important;\"><span style=\"max-width: 100%;  line-height: 1.75 color: rgb(84, 84, 84); box-sizing: border-box !important; word-wrap: break-word !important;font-size:15px;font-style: normal;font-family: PingfangSC-LIGHT,sans-serif;\">"
	...
	CSSStyleMap["</p>"] = "</span></p>"
	CSSStyleMap["<strong>"] = "<strong style=\"visibility: visible;\"><span style=\"color: rgb(255, 0, 0); visibility: visible;\" data-style=\"color: rgb(255, 0, 0);\" class=\"js_darkmode__11\">"
	CSSStyleMap["</strong>"] = "</span></strong>"
