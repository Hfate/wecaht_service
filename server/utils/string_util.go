...
func init() {
	...
	CSSStyleMap["<li><p>"] = "<li><p style=\"margin: 5px; max-width: 100%; min-height: 1em; white-space: pre-wrap; text-align: justify; line-height: 1.5; box-sizing: border-box !important; word-wrap: break-word !important;\"><span style=\"max-width: 100%; line-height: 30px; color: rgb(84, 84, 84); box-sizing: border-box !important; word-wrap: break-word !important;font-size:15px;font-style: normal;font-family: PingfangSC-LIGHT,sans-serif;\">"
	CSSStyleMap["<strong>"] = "<span style=\"max-width: 100%; line-height: 28px; box-sizing: border-box !important; word-wrap: break-word !important;letter-spacing:1px;font-size:15px;font-family: PingfangSC-LIGHT,sans-serif;\"><strong style=\"background: linear-gradient(to right,rgb(73, 200, 149),rgb(38, 198, 218));color: white;white-space: pre-wrap;border-width: 0.25em 0;display: inline;font-weight: normal;padding: 2px 4px 2px 4px;\">"
	CSSStyleMap["</strong>"] = "</strong></span>"
	CSSStyleMap["<p>"] = "<p   style=\"margin: 20px; max-width: 100%; min-height: 1em; white-space: pre-wrap; color: rgb(43, 43, 43); text-align: justify; line-height: 1.5; box-sizing: border-box !important; word-wrap: break-word !important; \"><span style=\"max-width: 100%; line-height: 28px; box-sizing: border-box !important; word-wrap: break-word !important;letter-spacing:1px;font-size:15px;font-family: PingfangSC-LIGHT,sans-serif;\">"
	CSSStyleMap["</p>"] = "</span></p>"
	CSSStyleMap["<span>"] = "<span style=\"max-width: 100%; line-height: 30px; color: rgb(84, 84, 84); box-sizing: border-box !important; word-wrap: break-word !important;font-size:15px;font-style: normal;font-family: PingfangSC-LIGHT,sans-serif;\">"
