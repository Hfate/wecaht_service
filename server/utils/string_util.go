...
func init() {
	...
	CSSStyleMap["<p>"] = "<p style=\"margin: 10px 10px; max-width: 100%; min-height: 1em; white-space: pre-wrap; color: rgb(137, 137, 137); text-align: justify; line-height: 1.75 box-sizing: border-box !important; word-wrap: break-word !important; \"><span line-height: 2 style=\"color: rgb(43, 43, 43); line-height: 28px;letter-spacing:1px;font-size:15px;font-family: PingfangSC-LIGHT,sans-serif;\">"
