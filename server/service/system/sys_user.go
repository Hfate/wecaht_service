...
func (userService *UserService) SetUserAuthority(id uint64, authorityId uint) (err error) {
...
func (userService *UserService) SetUserAuthorities(id uint64, authorityIds []uint) (err error) {
