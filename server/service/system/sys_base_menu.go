...
func (baseMenuService *BaseMenuService) DeleteBaseMenu(id uint64) (err error) {
...
func (baseMenuService *BaseMenuService) GetBaseMenuById(id uint64) (menu system.SysBaseMenu, err error) {
